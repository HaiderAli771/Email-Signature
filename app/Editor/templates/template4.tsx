...
import { instagramImage } from './images';
            ...
            <div style={{}} className='md:flex md:flex-col'>
                ...
                <div style={{ display: 'inline-table', marginTop: 'auto', marginBottom: 'auto', paddingRight: '20px' }}>
                    ...
                    <div style={{ fontFamily: selectedFont, fontSize: `${fontSize}px`, }}>
                        ...
                        <p style={{ fontWeight: '600', color: nameColor, margin: '0px' }}>{name}</p>
                        <p style={{ margin: '0px', fontWeight: '800', }} >{title}</p>
                        <p className="mb-2 font-medium" style={{ margin: '0px' }}>{company}</p>
                    </div>
                </div>
